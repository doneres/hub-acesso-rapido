...
const LEVELS = [
  {
    ...
    puzzleIds: ['bug-01','bug-02','seq-01','seq-02','log-01','log-02','alg-01'],
    neededToUnlockNext: 4,
  },
  {
    id: 2, label: 'INVESTIGADOR',
    color: '#f59e0b', glow: 'rgba(245,158,11,0.2)',
    desc: 'Intermediário — raciocínio lógico e análise de algoritmos',
    puzzleIds: ['bug-03','bug-04','seq-03','seq-04','log-03','log-04','alg-02','alg-03'],
    neededToUnlockNext: 5,
  },
  {
    id: 3, label: 'ELITE',
    color: '#ef4444', glow: 'rgba(239,68,68,0.2)',
    desc: 'Avançado — os casos mais difíceis. Apenas os melhores chegam aqui',
