    ...
    <div className="max-w-2xl mx-auto mb-8">
      <div className="relative group">
        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          <svg
            className="h-5 w-5 text-gray-400 group-focus-within:text-ctrl-orange transition-colors"
        ...
        {!value && (
          <div className="absolute inset-y-0 right-0 pr-4 flex items-center gap-1 pointer-events-none">
            <kbd className="hidden sm:flex items-center gap-1 px-2 py-1 text-[10px] font-bold text-gray-400 dark:text-slate-500 bg-gray-100 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-md">
              {isMac ? '⌘' : 'Ctrl'}
            </kbd>
            <kbd className="hidden sm:flex items-center gap-1 px-2 py-1 text-[10px] font-bold text-gray-400 dark:text-slate-500 bg-gray-100 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-md">
              K
